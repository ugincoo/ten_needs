...
document.querySelector('.premimg').src = `/ten__needs/tenneeds/jsp/member/mimg/${memberInfo.mimg == null ? 'default.png' : memberInfo.mimg }`;
...
function onchecked(){
	...
	if(check){
      document.querySelector('.premimg').src = `/ten__needs/tenneeds/jsp/member/mimg/default.png`;
